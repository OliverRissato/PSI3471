...
#Daqui adiante e’ codigo para mostrar a divisao do espaco dos atributos
...
gridx = np.arange(minx, maxx, 0.002)
gridy = np.arange(miny, maxy, 0.001)
xx, yy = np.meshgrid(gridx, gridy)
r1, r2 = xx.flatten(), yy.flatten()
r1, r2 = r1.reshape((len(r1), 1)), r2.reshape((len(r2), 1))

grid = np.hstack((r1,r2))
distance, yhat = vizinho.predict(grid)
